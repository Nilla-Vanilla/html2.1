document.addEventListener("DOMContentLoaded", () => {
    ...
    overlay.setAttribute('data-state', 'rising-fast'); // Uses the 0.5s CSS transition

    // 2. The 500ms Pause AFTER it drops
    setTimeout(() => {
        // We switch the attribute which removes the 'down' transition 
        // and triggers the rise animation
        overlay.style.display = 'flex';

        mainSite.classList.add('reveal-site');
    }, 500); // FIXED: Changed from 0 to 500ms
